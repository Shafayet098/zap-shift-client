...
import { MdDashboard, MdDirectionsBike, MdPayment } from "react-icons/md";
    ...
    return (
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                ...
                {/* Page content here */}
                <div className="p-4 bg-white h-[89%]">
                    <Outlet></Outlet>
                </div>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-primary is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu w-full grow">
                        ...
                        {/* My payment details  */}
                        <li>
                            <NavLink to='/dashboard/payment-history' className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Payment Details">
                                <MdPayment size={16} />
